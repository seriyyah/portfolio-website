...
export const workExperience: WorkExperience[] = [
  {
    ...
    description: 'Leading architectural decisions and system design for startup projects. Evolved from Senior Backend Developer (2022) to Team Lead (2023) to Architect (2024). Architecting distributed systems with frontend on Vercel, backend on Digital Ocean, and AWS for cloud storage solutions.',
    technologies: ['Python', 'PHP', 'Laravel', 'Microservices', 'DDD', 'TDD', 'Docker', 'AWS', 'Digital Ocean', 'Supabase', 'SendGrid', 'Stripe API', 'Third-party Integrations'],
    achievements: [
      'Successfully migrated frontend to separate Vercel deployment for improved performance',
      'Designed and implemented microservices architecture for multiple projects',
      'Integrated Supabase for database visualization and management dashboard access',
      'Implemented comprehensive API integrations including Stripe payments and SendGrid email services',
      'Architected distributed infrastructure: Vercel (frontend), Digital Ocean (backend), AWS (storage)',
      'Led technical team and established development best practices',
      'Evolved from developer to architect role within 2 years',
